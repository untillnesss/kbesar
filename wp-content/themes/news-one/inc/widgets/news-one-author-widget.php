...
if (!class_exists('News_One_Author_Widget')) :
     ...
     */
    class News_One_Author_Widget extends WP_Widget
    {
        ...
        {
            $opts = array(
                'classname' => 'news_one_widget_author',
                'description' => esc_html__('News One Author Profile', 'news-one'),
            );
            parent::__construct('news-one-author-widget', esc_html__('News One Author Widget', 'news-one'), $opts);
        }
        ...
        function widget($args, $instance)
        {
            ...
            <div class="author-profile">
                ...
                <div class="profile-wrapper social-menu-wrap social-links">
                    <?php
                    ...
                    <?php if ($author_facebook || $author_twitter || $author_linkedin || $author_instagram || $author_pinterest || $author_youtube || $author_vk) { ?>
                        <ul class="menu author-social-profiles news-one-menu-social">
                            <?php if ($author_facebook) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_facebook); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('facebook', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_twitter) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_twitter); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('twitter', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_linkedin) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_linkedin); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('linkedin', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_instagram) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_instagram); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('instagram', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_pinterest) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_pinterest); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('pinterest', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_youtube) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_youtube); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('youtube', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_vk) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_vk); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('vk', 'news-one'); ?></span></a>
                                </li>
                            <?php } ?>
        ...
        function form($instance)
        {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'news-one'); ?></strong></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><strong><?php esc_html_e('Description:', 'news-one'); ?></strong></label>
            ...
            <p>
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_image'); ?>"
                       value="<?php esc_attr_e('Upload Image', 'news-one') ?>"/>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_facebook')); ?>">
                    <?php esc_html_e('Facebook:', 'news-one'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_twitter')); ?>">
                    <?php esc_html_e('Twitter:', 'news-one'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_linkedin')); ?>">
                    <?php esc_html_e('LinkedIn:', 'news-one'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_instagram')); ?>">
                    <?php esc_html_e('Instagram:', 'news-one'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_pinterest')); ?>">
                    <?php esc_html_e('Pinterest:', 'news-one'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_youtube')); ?>">
                    <?php esc_html_e('Youtube:', 'news-one'); ?>
                </label>
...
add_action( 'widgets_init', 'news_one_author_widget' );
function news_one_author_widget()
{
    register_widget( 'News_One_Author_Widget' );
}

add_action('admin_enqueue_scripts', 'news_one_widgets_backend_enqueue');
function news_one_widgets_backend_enqueue()
{
